...
`).join("");
  ...
  const printItemRows = items.filter(item => {
        ...
        <section class="sp-two">
          <div class="sp-box">
            ...
            <div class="sp-address">
              ...
              ${result.business ? `<br>${escapeHtml(result.business)}` : ""}
              ${result.address ? `<br>${escapeHtml(result.address)}` : ""}
              ${result.phone ? `<br>${escapeHtml(result.phone)}` : ""}
              ${result.email ? ` &bull; ${escapeHtml(result.email)}` : ""}
            </div>
          </div>
          <div class="sp-box">
            ...
            <div class="sp-address">
              <strong>${escapeHtml(result.customer || "")}</strong>
              ${result.address ? `<br>${escapeHtml(result.address)}` : ""}
              ${result.delivery ? `<br>${escapeHtml(result.delivery)}` : ""}
            </div>
          </div>
        </section>
